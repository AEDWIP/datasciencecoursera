...
faster and be easier to understand.

In general we do not want to edit the raw data we down loaded. Instead we create
a new clean data set. The first thing we want to get rid of the first 7 columns.
