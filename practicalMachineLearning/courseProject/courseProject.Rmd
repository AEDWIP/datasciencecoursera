...
* clean up any tempory variables

```{r load data into memory and split into training and test sets}
library(data.table)
library(caret)
...
options(warn=-1) 
rm(csv, trainSetDF, testSetDF, dataDir, dataFileZip, dateDownLoaded, testingDataFile,
   trainingDataFile, fileURL, docFile, fileName)
options(warn=0) 
```
