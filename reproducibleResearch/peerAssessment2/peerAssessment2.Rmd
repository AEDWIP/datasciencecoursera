...
Storm types that where the most destructive interms of either economic cost or public health. The most harmful storm types in terms of public health where found to be "Tornados", "Excessive Heat", and "TSTM Wind". The most harmful storm types in terms of ecnomic cost where found to be "Flood", "Hurricane/Typhoon", and "Strom Surge".
